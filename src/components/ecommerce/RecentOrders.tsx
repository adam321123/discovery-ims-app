...
interface Product {
  ...
  outStock: string; // outStock of the product (as a string with currency symbol)
  // status: string; // Status of the product
  image: string; // URL or path to the product image
  status: "Terkirim" | "Pending" | "Batal Kirim"; // Status of the product
}
  ...
  return (
    <div className="overflow-hidden  rounded-xl  bg-white  dark:bg-white/[0.03]">
      <div className="flex flex-col gap-2 px-4 py-4 border border-b-0 border-gray-100 dark:border-white/[0.05] rounded-t-xl sm:flex-row sm:items-center sm:justify-between">
        <h3 className="col-span-12 space-y-6 xl:col-span-12 text-lg font-semibold text-gray-800 dark:text-white/90">
          Barang Keluar Hari Ini
        </h3>
      </div>
      <div className="flex flex-col gap-2 px-4 py-4 border-l border-r border-b-0 border-gray-100 dark:border-white/[0.05] sm:flex-row sm:items-center sm:justify-between">
          ...
          <Table>
            <TableHeader>
              <TableRow>
                <TableCell
                  isHeader
                  className="sm:pl-6 px-4 py-3 border border-gray-100 dark:border-white/[0.05]"
                >
            ...
            <TableBody>
              {currentData.map((item, index) => (
                <TableRow key={index}>
                  <TableCell className="sm:pl-6 px-4 py-4 border border-gray-100 dark:border-white/[0.05] dark:text-white/90 whitespace-nowrap">
                    <div className="flex items-center gap-3">
